  ...
  return (
    <main className="flex-1 bg-slate-950 flex justify-center p-3 sm:p-6 md:p-10 overflow-y-auto">
      <div
        id="print-sheet"
        ref={printRef}
        className="print-area box-border w-full max-w-[800px] aspect-[1/1.414] bg-white text-slate-900 p-8 sm:p-12 shadow-2xl shadow-black/40 border border-slate-100 flex flex-col justify-between transition-all rounded-xl lg:rounded-none"
      >
        {/* Cabecera */}
